...
<?php
    ...
    if (isset($_POST['Remover'])){
        //Obter o valor do ID da quantidade e limpar os valores POST
        $id_quantidade = limpar($_POST['id_quantidade']);
         
        //Excluir a entrada
        $result = mysql_query("DELETE FROM quantidades WHERE id_quantidade = '$id_quantidade'")
        or die("Houve um problema ao excluir a quantidade... \n" . mysql_error()); 
