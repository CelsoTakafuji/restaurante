...
<?php
	...
	if(isset($_POST['Alterar'])){
		...
		$quantidade_valor = limpar($_POST['quantidade_valor']);
				
		//Atualizar
		$resultado = mysql_query("UPDATE quantidades SET quantidade_valor = '$quantidade_valor' WHERE id_quantidade = '$id_quantidade'")
		...
		// Gerar um erro
		{
			die("Falha ao alterar quantidade..." . mysql_error());
		}
	}
?>