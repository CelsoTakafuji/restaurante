...
<?php
    ...
    if(isset($_POST['Alterar'])){
		...
		$categoria_nome = limpar($_POST['categoria_nome']);
	 
		//Atualizar
		$resultado = mysql_query("UPDATE categorias SET categoria_nome = '$categoria_nome' WHERE id_categoria = '$id_categoria'")
		or die("Algo está errado... \n". mysql_error()); 
		 
		//Verificar se a query foi executada
		if($resultado) {
			if(isset($_POST['pagina'])){
				//Redirecionar para voltar para a página de categorias
		...
		// Gerar um erro
		{
			die("Falha ao alterar uma categoria..." . mysql_error());
		}
    }
?>