...
<?php
    ...
    if(isset($_POST['Alterar'])){
		...
		//Atualizar
		$resultado = mysql_query("UPDATE funcionarios SET nome = '$nome', sobrenome = '$sobrenome', endereco = '$endereco', celular = '$celular' WHERE id_funcionario = '$id_funcionario'")
		...
		// Gerar um erro
		{
			die("Falha ao alterar um funcionário..." . mysql_error());
		}
    }
?>