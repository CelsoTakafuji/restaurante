...
<?php
	...
	if(isset($_POST['Alterar'])){
		...
		$forma_pagto_descricao = limpar($_POST['forma_pagto_descricao']);
		
		//Atualizar
		$resultado = mysql_query("UPDATE formas_pagto SET forma_pagto_descricao = '$forma_pagto_descricao' WHERE id_forma_pagto = '$id_forma_pagto'")
		...
		// Gerar um erro
		{
			die("Falha ao alterar forma de pagamento..." . mysql_error());
		}
	}
?>