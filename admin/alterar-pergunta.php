...
<?php
	...
	if(isset($_POST['Alterar'])){
		...
		$pergunta = limpar($_POST['pergunta']);
				
		//Atualizar 
		$resultado = mysql_query("UPDATE perguntas SET pergunta = '$pergunta' WHERE id_pergunta = '$id_pergunta'")
		...
		// Gerar um erro
		{
			die("Falha ao alterar pergunta..." . mysql_error());
		}
	}
?>