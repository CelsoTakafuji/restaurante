...
<?php
    ...
    if (isset($_POST['Remover'])){
        //Obter o valor do ID da mesa e limpar os valores POST
        $id_mesa = limpar($_POST['id_mesa']);
         
        //Excluir a entrada
        $resultado = mysql_query("DELETE FROM mesas WHERE id_mesa = '$id_mesa'")
        or die("Houve um problema ao excluir a mesa... \n" . mysql_error()); 
