...
<?php
    ...
    if (isset($_GET['id']))
    {
        ...
        $resultado_1 = mysql_query("DELETE FROM carrinhos WHERE id_pedido = '$id_pedido'")
        or die("Houve um problema ao excluir pedidos do carrinho... \n" . mysql_error()); 
         
        //Excluir o pedido
        $resultado_2 = mysql_query("DELETE FROM pedidos WHERE id_pedido = '$id_pedido'")
        or die("Houve um problema ao excluir pedido... \n" . mysql_error()); 
