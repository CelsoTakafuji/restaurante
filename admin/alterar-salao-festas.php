...
<?php
	...
	if(isset($_POST['Alterar'])){
		...
		$salao_festas_nome = limpar($_POST['salao_festas_nome']);
				
		//Atualizar
		$resultado = mysql_query("UPDATE saloes_festa SET salao_festas_nome = '$salao_festas_nome' WHERE id_salao_festas = '$id_salao_festas'")
		...
		// Gerar um erro
		{
			die("Falha ao alterar um salão de festas..." . mysql_error());
		}
	}
?>