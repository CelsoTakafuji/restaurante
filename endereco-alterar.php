...
<?php
	...
	if (isset($_GET['id']))
	{
		...
		$qry = "UPDATE enderecos SET id_cliente  = '$id_cliente', endereco = '$endereco', cep = '$cep', cidade = '$cidade', celular = '$celular', telefone = '$telefone' WHERE id_cliente = '$id_cliente'";
		mysql_query($qry) or die("Erro ao alterar endereço do cliente! Erro no banco: ". mysql_error()); ;
	
		//Redirecionar para a página de faturamento com sucesso
		header("Location: meu-perfil.php");
	}else {
		die("Falha ao alterar informações de endereço! Por favor tente novamente após alguns minutos.");
	}
?>